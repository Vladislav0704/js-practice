...
// const checkLogin = prompt('Enter your login');
// const password = prompt('Enter your password');
// const login = 'Bob';

// if (login === 'Bob' || password === 123) {
//     console.log('Приветствую тебя Bob');
// } else {
//     console.log('Попытки закончились Доступ запрещен');
// }

// const user = {
//     password: "<&N2=2zH%]F{j@.b"
// };
...
//         i = 0;
//     } else if (user.password != userInput && i != 0) {
//         alert("Пароль неверный, осталось " + i + " попытки.");
//     } else {
//         alert("Вы исчерпали все попытки входа. Пожалуйста, попробуйте позже.");
//     }
// }
